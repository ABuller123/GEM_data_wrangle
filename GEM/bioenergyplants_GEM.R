...
GEM <-read_excel("/Users/2diigermany/Desktop/Work/GEM /Power/Global-Bioenergy-Power-Tracker-GBPT-September-2024.xlsx", sheet = "Data")

GEM_belowthreshold <-read_excel("/Users/2diigermany/Desktop/Work/GEM /Power/Global-Bioenergy-Power-Tracker-GBPT-September-2024.xlsx", sheet = "Below Threshold")
...
#Renaming Owners to allow for more streamlined processing
GEM_relevant <- GEM_relevant %>%
  rename(Owner = `Owner(s)`)
...
#write results
write.csv(GEM_timeseries_aggregated,"/Users/2diigermany/Desktop/Work/GEM /Wrangled/GEM_Bioenergy.csv", row.names = F)
